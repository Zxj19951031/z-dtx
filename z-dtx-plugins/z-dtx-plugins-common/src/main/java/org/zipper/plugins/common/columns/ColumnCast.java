...
import org.zipper.plugins.common.columns.BytesColumn;
import org.zipper.plugins.common.columns.DateColumn;
import org.zipper.plugins.common.columns.StringColumn;
...
public class ColumnCast {
    public static void bind(final JsonObject configuration) {
...
class DateCast {
    ...
    static void init(final JsonObject configuration) {
        ...
        switch (column.getSubType()) {
            ...
            default:
                throw HelperException
                        .newException(ColumnError.CONVERT_NOT_SUPPORT,
