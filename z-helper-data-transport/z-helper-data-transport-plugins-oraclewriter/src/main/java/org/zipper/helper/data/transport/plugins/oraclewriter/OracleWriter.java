...
public class OracleWriter extends Writer {
    ...
    public static class Job extends Writer.Job {
        ...
        private static final Logger log = LoggerFactory.getLogger(OracleWriter.Job.class);
        ...
        public void init() {
            ...
            try {
                ...
                String sql = String.format("select * from (%s) where 1=0", SqlUtil.buildQuerySql(getAllConfig()));
    ...
    public static class Task extends Writer.Task {
        private static final Logger log = LoggerFactory.getLogger(OracleWriter.Task.class);
