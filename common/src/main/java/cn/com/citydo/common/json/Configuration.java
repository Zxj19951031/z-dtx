/*
 * Copyright (c) 2019/4/10 11:37:54
 * Created by zhuxj
 */
...
/**
 * @author copy from datax
 */
public class Configuration implements Serializable {


    private static final long serialVersionUID = -363720471110324996L;
    ...
    public static Configuration from(String json) {
        ...
        try {
            ...
            throw SysException.newException(JsonError.JSON_PARES_ERROR, e.getMessage());
        }
     ...
     * @return Configuration
     */
    public static Configuration from(final Map<String, Object> map) {
        return Configuration.from(Configuration.toJSONString(map));
    }
     ...
     * @return Configuration
     */
    public static Configuration from(final List<Object> list) {
        return Configuration.from(Configuration.toJSONString(list));
    }
     ...
     *
     * @param key        键
     * @param IErrorCode 异常值类型
     * @return value 值
     * @throws SysException 异常
     */
    public String getNecessaryValue(String key, IErrorCode IErrorCode) throws SysException {
        String value = this.getString(key, null);
        if (StringUtils.isBlank(value)) {
            throw SysException.newException(IErrorCode,
     ...
     * @param IErrorCode   异常码
     * @return value 值
     */
    public String getUnnecessaryValue(String key, String defaultValue, IErrorCode IErrorCode) {
     ...
     * @throws SysException 异常
     */
    public Boolean getNecessaryBool(String key, IErrorCode IErrorCode) throws SysException {
    ...
    public Boolean getBool(final String path) {
        ...
        if (null == result) {
            ...
            throw SysException.newException(JsonError.CONFIG_ERROR,
     ...
     * 对于插入对象，Configuration不做任何限制，但是请务必保证该对象是简单对象(包括Map、List)
    ...
    public Object remove(final String path) {
        ...
        if (null == result) {
            throw SysException.newException(
                    JsonError.CONFIG_ERROR,
                    String.format("配置文件对应Key[%s]并不存在，该情况是代码编程错误. 请联系开发团队的同学.", path));
        }
    ...
    @SuppressWarnings("unchecked")
    public void getKeysRecursive(final Object current, String path, Set<String> collect) {
    ...
    Object buildObject(final List<String> paths, final Object object) {
        ...
        for (int i = paths.size() - 1; i >= 0; i--) {
            ...
            throw SysException.newException(
                    JsonError.CONFIG_ERROR, String.format(
